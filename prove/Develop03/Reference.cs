namespace Develop03
{
    public class Reference
    {
        ...
        public Reference(int verses)
        {
            this.DictionaryGenerator(verses);
            this.SelectScripture();
        }

        private void DictionaryGenerator()
        {
        ...
        private void DictionaryGenerator(int verses)
        {
        ...
        private void SelectScripture()
        {
            int tempIndex = this._rand.Next(this._scriptures.Count());
            Reference.verse = _scriptures.ElementAt(tempIndex).Key;
            Reference.scripture = _scriptures.ElementAt(tempIndex).Value;
        }
